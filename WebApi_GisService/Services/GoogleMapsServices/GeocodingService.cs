...
using WebApi_GisService.Infrastructure;

namespace WebApi_GisService.Services.GoogleMapsServices
{
    public class GeocodingService : IServiceGeoCoding
    {
        ...
        public GeocodingService(IOptions<List<GeoCodingServiceSettings>> servicesSettings)
        {
        ...
        public async Task<GeoCodingServiceResult> GetAsync(string address, CultureInfo culture, HttpClient httpClient)
        {
            ...
            try
            {
                ...
                if (httpResponseMessage.IsSuccessStatusCode)
                {
                    ...
                    GeocodingModels googleResult = (JsonConvert.DeserializeObject<GeocodingModels>(contentString));
